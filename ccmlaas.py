...
ntt = st.slider("Non-Talk Time (NTT)", min_value=data['NTT'].min(), max_value=data['NTT'].max())
sentiment = st.slider("Sentiment", min_value=data['Sentiment'].min(), max_value=data['Sentiment'].max())
complaints = st.slider("Complaints", min_value=1, max_value=10)
repeats = st.slider("Repeats", min_value=1, max_value=10)
